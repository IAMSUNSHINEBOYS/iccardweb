...
jQuery.validator.addMethod("checkUserName", function(value, element) {
    var data = "id=" + $("#adminUpdateForm input[name='id']").val();
    data += "&username=" + $("#adminUpdateForm input[name='username']").val();
    return remoteSyncCheck("admin/checkUserName?flag=1", data);
});
